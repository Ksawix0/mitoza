...
#         [int]$length = 32
#     )
#     Write-Output ((-join ((1..9)+(11..33)+(35..57)+59+61+(64..91)+(93..123)+(125..126) | Get-Random -Count $length | ForEach-Object {[char]$_}))|Sort-Object {Get-Random})
# }
